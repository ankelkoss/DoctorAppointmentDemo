...
{
    public class JsonAppointmentRepository : JsonGenericRepository<Appointment>, IAppointmentRepository
    {
        ...
        {
            FileStorageConfig = ReadFromAppSettings().Database.Appointments.Json;
            _doctorRepository = new JsonDoctorRepository();
            _patientRepository = new JsonPatientRepository();
        }
        ...
        protected override string SerializeAll(IEnumerable<Appointment> items)
        {
            ...
            return JsonConvert.SerializeObject(appointmentDTO, Formatting.Indented);
        }
    }
}
